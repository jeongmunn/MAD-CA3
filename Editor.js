        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.editor}>
                    ...
                    <TouchableOpacity style={styles.option}>
                        <Image source={require('./assets/image/filter.png')} style={styles.icon} />
                        <Text style={styles.text}>FILTER</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.option}>
                        <Image source={require('./assets/image/adjust.png')} style={styles.icon} />
                        <Text style={styles.text}>ADJUST</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.option}>
                        <Image source={require('./assets/image/text.png')} style={styles.icon} />
                        <Text style={styles.text}>TEXT</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.option}>
                        <Image source={require('./assets/image/crop.png')} style={styles.icon} />
